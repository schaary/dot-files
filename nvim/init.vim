...
if has('vim_starting')
  ...
  " Required:
  set runtimepath+=/Users/nmaef/.config/nvim/bundle/neobundle.vim/
endif

" Required:
call neobundle#begin(expand('/Users/nmaef/.config/nvim/bundle'))
...
" set command for CTRL-P plugin to CTRL-T, such it behave like TextMate
